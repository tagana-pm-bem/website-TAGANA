        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-4">
              <button
                onClick={() => router.push('/')}
                className="px-3 lg:px-4 py-2 text-sm lg:text-base font-semibold text-gray-700 hover:text-[#044BB1] hover:bg-blue-50 rounded-lg transition-all duration-300"
              >
                Beranda
              </button>
              ...
              <button
                ...
                className="px-3 lg:px-4 py-2 text-sm lg:text-base font-semibold text-gray-700 hover:text-[#044BB1] hover:bg-blue-50 rounded-lg transition-all duration-300 flex items-center gap-1.5"
              >
              ...
              <button
                onClick={() => router.push('/tanggal&event')}
                className="px-3 lg:px-4 py-2 text-sm lg:text-base font-semibold text-gray-700 hover:text-[#044BB1] hover:bg-blue-50 rounded-lg transition-all duration-300 flex items-center gap-1.5"
              >
