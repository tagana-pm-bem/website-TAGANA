...
export function AdminSidebar() {
 ...
 {/* Other Menu item */}
  const otherMenuItems: MenuItem[] = [
    {
      ...
      label: "Kalender Event list",
      path: "/admin/KalenderEventlist",
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  useEffect(() => {
    const currentMenuItem = [...mainMenuItems, ...otherMenuItems, ...settingsItems].find(
  ...
  return (
    <aside className="w-64 h-screen bg-gray-50 shadow-lg text-black flex flex-col overflow-y-auto">
      ...
      {/* Other Menu */}
      <nav className="px-4 py-2 space-y-2 border-t border-gray-300">
        <h3 className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">Other Menu</h3>
      ...
      {/* Settings Menu */}
      <nav className="px-4 py-4 space-y- border-t border-gray-300 ">
