      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        ...
        {!isEditing && (
          <div className="relative w-full h-48 bg-gray-200 flex-shrink-0">
            ...
            />
            <button onClick={onClose} className="absolute top-3 right-3 bg-black/30 hover:bg-black/50 text-white p-1.5 rounded-full backdrop-blur-md">
              <X size={20} />
            </button>
          </div>
        )}
        ...
        {isEditing ? (
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 flex gap-3">
              <button onClick={() => setIsEditing(false)} className="flex-1 py-2 rounded-lg border border-gray-300 bg-white text-gray-700 hover:bg-gray-50">Batal</button>
              <button onClick={handleSave} disabled={isSaving} className="flex-1 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 flex items-center justify-center gap-2">
          ...
          <>
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 flex gap-3">
              <button onClick={() => setIsEditing(true)} className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-700 font-semibold hover:bg-gray-100">
                <Edit size={16} /> Edit
              </button>
              <button onClick={handleDeleteClick} disabled={isDeleting} className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-red-600 text-white font-semibold hover:bg-red-700 disabled:opacity-70">
                {isDeleting ? <Loader2 className="animate-spin" size={16} /> : <Trash2 size={16} />} Hapus
              </button>
            </div>
          </>
        )}
