...
export function Header({ title = "Berita Bencana", subtitle = "Informasi terkini tentang bencana di Desa Sriharjo", onBack }: { title?: string; subtitle?: string; onBack?: () => void }) {
  return (
